...
import com.launchableinc.openai.completion.chat.ChatCompletionRequest.ChatCompletionRequestFunctionCall;
import com.launchableinc.openai.service.FunctionExecutor;
...
class OpenAiApiFunctionsExample {
	...
	public static void main(String... args) {
		...
		FunctionExecutor functionExecutor = new FunctionExecutor(
				Collections.singletonList(ChatFunction.builder()
						.name("get_weather")
						.description("Get the current weather of a location")
						.executor(Weather.class,
		...
		while (true) {
			...
			if (functionCall != null) {
				...
				Optional<ChatMessage> message = functionExecutor.executeAndConvertToMessageSafely(
						functionCall);
