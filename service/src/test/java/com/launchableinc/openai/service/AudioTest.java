...
import com.launchableinc.openai.audio.CreateTranscriptionRequest;
...
public class AudioTest {
	...
	void createTranscription() {
		...
		String text = service.createTranscription(createTranscriptionRequest, englishAudioFilePath)
				.getText();
	...
	void createTranscriptionVerbose() {
		...
		TranscriptionResult result = service.createTranscription(createTranscriptionRequest,
	...
	void createTranslation() {
		...
		String text = service.createTranslation(createTranslationRequest, koreanAudioFilePath)
				.getText();
	...
	void createTranslationVerbose() {
		...
		TranslationResult result = service.createTranslation(createTranslationRequest,
				koreanAudioFilePath);
