...
/**
 * Class that accumulates chat messages and provides utility methods for handling message chunks and
 * function calls within a chat stream. This class is immutable.
 *
 * @author [Your Name]
 */
public class ChatMessageAccumulator {
	...
	public boolean isFunctionCall() {
		return getAccumulatedMessage().getFunctionCall() != null
				&& getAccumulatedMessage().getFunctionCall().getName() != null;
	}
	...
	/**
	 * Retrieves the function call from the message chunk. This is equivalent to
	 * getMessageChunk().getFunctionCall().
	 *
	...
	/**
	 * Retrieves the function call from the accumulated message. This is equivalent to
	 * getAccumulatedMessage().getFunctionCall().
	 *
