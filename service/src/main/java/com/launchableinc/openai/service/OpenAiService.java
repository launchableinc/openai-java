...
import com.launchableinc.openai.*;
import com.launchableinc.openai.assistants.*;
import com.launchableinc.openai.audio.*;
...
import com.launchableinc.openai.image.CreateImageEditRequest;
...
public class OpenAiService {
	...
	public OpenAiResponse<Assistant> listAssistants(ListSearchParameters params) {
		Map<String, Object> queryParameters = mapper.convertValue(params,
	...
	public OpenAiResponse<AssistantFile> listAssistantFiles(String assistantId,
	...
	public Run submitToolOutputs(String threadId, String runId,
	...
	/**
	 * Calls the Open AI api and returns a Flowable of type T for streaming omitting the last
	 * message.
	 *
	 * @param apiCall The api call
	...
	public void shutdownExecutor() {
		Objects.requireNonNull(this.executorService,
				"executorService must be set in order to shut down");
	...
	public Flowable<ChatMessageAccumulator> mapStreamToAccumulator(
			...
			if (messageChunk.getFunctionCall() != null) {
				if (messageChunk.getFunctionCall().getName() != null) {
					...
					functionCall.setName(
							(functionCall.getName() == null ? "" : functionCall.getName()) + namePart);
				}
				...
				accumulatedMessage.setContent(
						(accumulatedMessage.getContent() == null ? "" : accumulatedMessage.getContent()) + (
	...
	/**
	 * Account API consumption amount information inquiry. Up to 100 days of inquiry.
	 *
	 * @param starDate
	 * @param endDate
