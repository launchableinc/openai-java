...
public class CreateImageRequest {
	 ...
	 * greater consistency across the image. This param is only supported for dall-e-3. Defaults to
	 * "standard".
	 */
	String quality;
	 ...
	 * Must be one of 1024x1024, 1792x1024, or 1024x1792 for dall-e-3 models. Defaults to 1024x1024.
	 */
	String size;
