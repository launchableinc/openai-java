...
public class FineTuneRequest {
	...
	/**
	 * The name of the base model to fine-tune. You can select one of "ada", "babbage", "curie", or
	 * "davinci". To learn more about these models, see the Engines documentation.
	 */
	String model;
	 ...
	 * you must specify {@link FineTuneRequest#classificationNClasses} for multiclass classification
	 * or {@link FineTuneRequest#classificationPositiveClass} for binary classification.
	 */
