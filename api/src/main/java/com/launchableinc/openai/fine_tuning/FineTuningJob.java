...
public class FineTuningJob {
	...
	/**
	 * The name of the fine-tuned model that is being created. Can be null if no fine-tuned model is
	 * created yet.
	 */
	...
	/**
	 * The current status of the fine-tuning job. Can be either created, pending, running, succeeded,
	 * failed, or cancelled.
	 */
	String status;
	...
	/**
	 * The file ID used for validation. Can be null if validation is not used.
	 */
