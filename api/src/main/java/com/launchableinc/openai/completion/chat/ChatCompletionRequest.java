...
public class ChatCompletionRequest {
	 ...
	 * href="https://platform.openai.com/docs/guides/chat/introduction">chat format</a>.<br> see
	 * {@link ChatMessage}
	 */
	 ...
	 * the top 10% probability mass are considered.<br> We generally recommend altering this or
	...
	/**
	 * Controls how the model responds to function calls, as specified in the <a
	 * href="https://platform.openai.com/docs/api-reference/chat/create#chat/create-function_call">OpenAI
	 * documentation</a>.
	 */
