...
public class CompletionRequest {
	 ...
	 * carefully and ensure that you have reasonable settings for {@link CompletionRequest#maxTokens}
	 * and {@link CompletionRequest#stop}.
	 */
	Integer n;
	 ...
	 * <p>
	 * When used with {@link CompletionRequest#n}, best_of controls the number of candidate
	 ...
	 * <p>
	 * Maps tokens (specified by their token ID in the GPT tokenizer) to an associated bias value from
	 * -100 to 100.
	 * <p>
